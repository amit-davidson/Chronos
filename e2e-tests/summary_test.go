...
func TestE2E(t *testing.T) {
	var testCases = []struct {
		...
		{name: "RecursionWithGoroutine", testPath: "general/RecursionWithGoroutine/prog1.go", resPath: "general/RecursionWithGoroutine/prog1_expected.json", shouldUpdate: true},
