...
is a static race detector for the golang language written in golang.
- Can find out race conditions without running the code
- Mark exactly the positions where instructions may conflict in different
